...
<head>
    ...
    <!-- am chart export.css -->
    <link rel="stylesheet" href="{{ asset('admin/https://www.amcharts.com/lib/3/plugins/export/export.css') }}"
                                    ...
                                    <li class="waves-effect waves-light">
                                        <div class="media">
                                            <img class="d-flex align-self-center img-radius"
                                                src="{{asset('admin/assets/images/avatar-2.jpg')}}" alt="Generic placeholder image">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <div class="">
                                <div class="main-menu-header">
                                    <img class="img-80 img-radius" src="{{asset('admin/assets/images/avatar-4.jpg')}}"
                                        alt="User-Profile-Image">
